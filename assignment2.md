...
| C05                  | addExamSchedule()             | 1. Method that allow user to add a scheduled exam on LMS   | 1.1 ExamSchedules list to not be null and initially empty.                                                     | 1.1 examSchedules list is not null and initially empty                      | Pass      | 
